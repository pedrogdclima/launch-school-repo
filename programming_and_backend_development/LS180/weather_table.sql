...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: pedrogdcl
--
...
ALTER TABLE public.weather OWNER TO pedrogdcl;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: pedrogdcl
--
